...
if (use_own_preproc_data) {
  ...
  # with our preprocessing, 46(/50) participants go into the analysis (exluding 1-3, 48).
...
You can consider to decrease the number of bootstrap repetitions (default is 10000).
```{r boostrap}
#--------------------------------------------------------------------------
# bootstrap main analysis


nBoot  <- 10 # number of repition of bootstrap procedure
