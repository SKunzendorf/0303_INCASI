...
#   idx <- which(d$vp==vplist[i])
#   d$vpnum[idx] <- i
# }
# d$vpnum <- as.factor(d$vpnum)
# 
# # d1: adapt for IA
# vplist1 <- unique(d1$vp)
# d1$vpnum <- 0
# for(i in 1:length(vplist1)){
#   idx <- which(d1$vp==vplist1[i])
#   d1$vpnum[idx] <- i
# }
# d1$vpnum <- as.factor(d1$vpnum)
#--------------------------------------------------------------------------
```
